...
class AGCNrec():
    def __init__(self,placeholders,input_dim_user,input_dim_item, user_dim, item_dim, learning_rate):
        ...
        with open('data/negative_num.pkl', 'rb')as p:
            self.negative_num = pkl.load(p)
    ...
    def hratNew(self):
        self.hratNew1 = hrNew(self.rate_matrix, self.negative, self.length, self.negative_num, k=1)
        self.hratNew5 = hrNew(self.rate_matrix, self.negative, self.length, self.negative_num, k=5)
        self.hratNew10 = hrNew(self.rate_matrix, self.negative, self.length, self.negative_num, k=10)
    ...
    def ndcgNew(self):
        self.ndcgNew1 = ndcgChange_1(self.rate_matrix, self.negative, self.length, self.negative_num, k=1)
        self.ndcgNew5 = ndcgChange_1(self.rate_matrix, self.negative, self.length, self.negative_num, k=5)
        self.ndcgNew10 = ndcgChange_1(self.rate_matrix, self.negative, self.length, self.negative_num, k=10)

    def rc(self):
        self.recall5 = recall(self.rate_matrix, self.negative, self.length, self.negative_num, k=5)
        self.recall10 = recall(self.rate_matrix, self.negative, self.length, self.negative_num, k=10)
    ...
    def auNew1(self):
        self.auc1 = aucChange_1(self.rate_matrix, self.negative, self.length, self.negative_num)
    def auNew2(self):
        self.auc2 = aucChange_2(self.rate_matrix, self.negative, self.length)